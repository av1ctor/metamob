...
eval dfx deploy metamob --network ic --with-cycles 1000000000000 --argument="'(\"$LEDGER_CANISTER_ID\", \"$BTCWALLET_CANISTER_ID\", \"$EMAILER_CANISTER_ID\", \"$MMT_CANISTER_ID\", \"$FILESTORE_CANISTER_ID\", \"$LOGGER_CANISTER_ID\")'"
