...
type OptionsCB = (value: string) => Promise<Option[]>;
...
const SelectField = (props: Props) => {
    ...
    const handleChangeSuggestion = useCallback(async (e: any) => {
        ...
        if(suggestion.length >= 3) {
            try {
                setIsLoading(true);
                const options = await (props.options as OptionsCB)(suggestion);
        ...
        <div className="field">
            ...
            {isStatic?
                <div className="control">
                    ...
                    >
                        {([{name:"", value:""}]).concat(props.options as Option[]).map((opt, index) => 
