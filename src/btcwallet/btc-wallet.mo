...
import EcdsaTypes "./mo-btc/src/ecdsa/Types";
import P2pkh "./mo-btc/src/bitcoin/P2pkh";
import Bitcoin "./mo-btc/src/bitcoin/Bitcoin";
import Address "./mo-btc/src/bitcoin/Address";
import Transaction "./mo-btc/src/bitcoin/Transaction";
import Script "./mo-btc/src/bitcoin/Script";
import Publickey "./mo-btc/src/ecdsa/Publickey";
import Der "./mo-btc/src/ecdsa/Der";
import Affine "./mo-btc/src/ec/Affine";

import Types "types";
import EcdsaApi "ecdsa-api";
            ...
            let transaction =
                Utils.get_ok_except(
                    Bitcoin.buildTransaction(
                        2, 
                        own_utxos, 
                        [(#p2pkh dst_address, amount)], 
                        #p2pkh own_address, 
                        Nat64.fromNat(total_fee)
                    ), 
